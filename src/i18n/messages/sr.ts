...
export const sr = {
  ...
  'auth.linkExpired': 'Veza iz e-pošte više ne važi. Zatražite novu.',
  'auth.reset.askTitle': 'Zaboravljena lozinka',
  'auth.reset.askSubtitle': 'Poslaćemo vezu za postavljanje nove lozinke.',
  'auth.reset.askAction': 'Pošalji vezu',
  'auth.reset.sent':
    'Ako nalog sa tom e-adresom postoji, veza je poslata. Važi jednom i kratko.',
  'auth.reset.invalidEmail': 'Unesite ispravnu e-adresu.',
  'auth.reset.backToSignIn': 'Nazad na prijavu',
  'auth.reset.setTitle': 'Nova lozinka',
  'auth.reset.setSubtitle': 'Unesite je dvaput, da se izbegne omaška u kucanju.',
  'auth.reset.newPassword': 'Nova lozinka',
  'auth.reset.confirmPassword': 'Ponovite lozinku',
  'auth.reset.setAction': 'Sačuvaj lozinku',
  'auth.reset.tooShort': 'Lozinka mora imati bar osam znakova.',
  'auth.reset.mismatch': 'Unosi se ne poklapaju.',
  'auth.reset.noSession': 'Veza je istekla. Zatražite novu sa strane za prijavu.',
  'auth.reset.rejected': 'Lozinka nije prihvaćena. Pokušajte sa drugom.',
  ...
  'retail.stockValue': 'Vrednost zalihe u {currency}',
  'retail.deadShare': 'Mrtav novac: {share}',
  'retail.shortageCount.one': '{count} artikal pred nestašicom',
  'retail.shortageCount.few': '{count} artikla pred nestašicom',
  'retail.shortageCount.other': '{count} artikala pred nestašicom',
  'retail.history': 'Mesečni tok',
  'retail.history.thisYear': 'Ova godina',
  'retail.history.lastYear': 'Isti mesec prošle godine',
  'retail.history.table': 'Prikaži brojeve',
  'retail.col.month': 'Mesec',
  'retail.dead.title': 'Mrtav novac u zalihama',
  'retail.dead.empty': 'Nema zalihe koja duže stoji bez prodaje. Novac radi.',
  'retail.items.one': '{count} artikal',
  'retail.items.few': '{count} artikla',
  'retail.items.other': '{count} artikala',
  'retail.dead.finding':
    '{value} stoji na polici bez prodaje duže od {days} dana — {share} ukupne zalihe, u {items}.',
  'retail.shortage.title': 'Nestaće pre isporuke',
  'retail.shortage.empty': 'Nijedan artikal neće nestati pre nego što stigne nova isporuka.',
  'retail.shortage.finding':
    '{items} će se potrošiti pre nego što stigne nova isporuka. Naručiti sada, ne sledeće nedelje.',
  'retail.volume.title': 'Mnogo prodaje, malo zarađuje',
  'retail.volume.empty': 'Nema artikla koji vuče promet a zaostaje po marži.',
  'retail.volume.finding':
    '{items} iz vrha po prometu nosi maržu osetno ispod proseka objekta ({average}). Podići cenu, pregovarati nabavku — ili ih svesno zadržati kao mamac.',
  'retail.abc.title': 'Šta zaista nosi promet',
  'retail.abc.finding':
    '{count} od {total} artikala nosi osamdeset posto prometa — {share} asortimana. Ti artikli ne smeju da nestanu sa police.',
  'retail.col.stock': 'Zaliha',
  'retail.col.value': 'Vrednost',
  'retail.col.lastSold': 'Bez prodaje',
  'retail.col.cover': 'Pokrivenost',
  'retail.col.lead': 'Rok isporuke',
  'retail.days': 'dana',
  'retail.analysisAsk': 'Pitaj sagovornika',
  'retail.ask.dead': 'Koji artikli u objektu {location} stoje bez prodaje i šta da radim sa njima?',
  'retail.ask.shortage': 'Šta da naručim za objekat {location} da ništa ne nestane?',
  'retail.ask.volume': 'Zašto artikli sa najvećim prometom u objektu {location} imaju slabu maržu?',
